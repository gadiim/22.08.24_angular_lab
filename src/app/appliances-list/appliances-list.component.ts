...
import { UpperCasePipe, DatePipe, CurrencyPipe, PercentPipe, NgFor, NgIf } from '@angular/common';

@Component({
  selector: 'app-appliances-list',
  standalone: true,
  imports: [UpperCasePipe, DatePipe, CurrencyPipe, PercentPipe, NgFor, NgIf],
